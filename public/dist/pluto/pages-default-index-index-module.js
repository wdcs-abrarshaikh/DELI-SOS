...
/* harmony import */ var _imageSlider_imageSlider_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../imageSlider/imageSlider.component */ "./src/app/theme/pages/imageSlider/imageSlider.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ViewrestaurantComponent = /** @class */ (function () {
    function ViewrestaurantComponent(activeModal, _router, _formBuilder, modalService, IndexService, toastService) {
        ...
        this.toastService = toastService;
        this.mealOffers = [];
        this.pdfIcon = '../../../../../../assets/PDF_file_icon.svg';
    }
    ...
    ViewrestaurantComponent.prototype.openImageSlider = function (images, index) {
        var temp = Object.assign([], images);
        if (temp[index].split('.').pop() == 'pdf') {
            window.open(temp[index]);
        }
        else {
            var imagesOnly_1 = [temp[index]];
            temp.splice(index, 1);
            temp.map(function (img) {
                var extension = img.split('.').pop();
                if (extension != 'pdf') {
                    imagesOnly_1.push(img);
                }
            });
            var modalRef = this.modalService.open(_imageSlider_imageSlider_component__WEBPACK_IMPORTED_MODULE_6__["ImageSliderComponent"], {
                size: 'lg',
                windowClass: 'imgPreview'
            });
            modalRef.componentInstance.images = imagesOnly_1;
        }
    };
    ViewrestaurantComponent.prototype.getMenuUrl = function (url) {
